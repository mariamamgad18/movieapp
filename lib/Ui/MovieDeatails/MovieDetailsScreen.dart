      ...
      body:FutureBuilder<MovieDetailsResponse>
        (
          ...
          builder: (context,snapshot){
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      onPressed: () {
                        setState(() {
                          _MovieDetails =
                              ApiManager().getMovieDetails(movieId: widget.movieId);
                        });
                      },
            ...
            print('Original descriptionFull: $description');  // أضف هذا للتحقق من القيمة الأصلية
                ...
                progressIndicatorColor: Appcolors.redColor,
                    ...
                    Stack(
                      children: [
                        ...
                        // أزرار الرجوع والحفظ فوق الصورة
                        Padding(
                        ...
                        // العناصر اللي هتكون في Bottom Center
                        Positioned(
                          bottom: 20,
                          left: 0,
                          right: 0,
                                ...
                                SizedBox(width: double.infinity,
                                  child: ElevatedButton(
                                    ...
                                    style: ElevatedButton.styleFrom(
                                      ...
                                      padding:
                                      EdgeInsets.symmetric(vertical: 16, horizontal: 121),
                                    ),
                                  ),
                                ),
                                SizedBox(height: 16),
                    ...
                    ,Padding(
                     ...
                     FutureBuilder<MovieSuggestionsResponse>(
                            ...
                            future:ApiManager().getMovieSuggestion(movieId: widget.movieId),
                            builder: (context, snapshot) {
                              if (snapshot.connectionState == ConnectionState.waiting) {
                                return Center(
                                  child: CircularProgressIndicator(color: Appcolors.yellowColor),
                              ...
                              if (snapshot.hasError || snapshot.data?.data?.movies == null || snapshot.data!.data!.movies!.isEmpty) {
                                return Text("No suggestions available", style: TextStyle(color: Colors.white));
                              }

                              final suggestions = snapshot.data!.data!.movies!;
                              final displaySuggestions = suggestions.length > 4 ? suggestions.sublist(0, 4) : suggestions;
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  return Movieitem(
                                    movies: Movies(
                                      ...
                                      largeCoverImage: movie.backgroundImage??'',
                                      rating: movie.rating,
                                    ),
                                  );
                                },
                          ...
                          Text(
                            description?.isNotEmpty == true ? description! : 'No description available',                            style: TextStyle(
                              color: Appcolors.whitekColor,
                              fontSize: 16,
...
,
                          ...
                          Wrap(
                            ...
                            spacing: 16,
                            runSpacing: 11,
                            children: movie.genres!.map((g) => Genereitem(Genere: g)).toList(),
                          ),
                        ],
                      ),
                    ),
