...
import '../Cubit/RegisterCubit/Register_States.dart';
import '../Cubit/RegisterCubit/Register_View_Model.dart';
    ...
    child: Builder(
      ...
      return BlocListener<RegisterViewModel,RegisterStates>(
        listener: (context,state){
          if (state is ReisterLoadingState) {
            MyDialog.show(
                context: context,
                title: "Loading",
                message: "Please wait...",
                onPressed: () {});
          } else if (state is ReisterSuccessState) {
            Navigator.pop(context);
            MyDialog.show(
              context: context,
              title: "Done",
              message: state.SuccessMsg ?? "Reisteration Successful",
              onPressed: () {
                Navigator.pushReplacementNamed(
                    context, Approutenames.LayoutScreens);
              },
            );
          } else if (state is ReisteErrorState) {
            Navigator.pop(context);
            MyDialog.show(
              context: context,
              title: "Error!",
